...
public enum ArmorMaterials implements ArmorMaterial {
    ...
    ArmorMaterials(String name, int durabilityMultiplier, int[] armorValues, int enchantability, SoundEvent equipSound, float toughness, java.util.function.Supplier<Ingredient> repairIngredient) {
        this.name = name;
    ...
    public int getDurabilityForType(ArmorItem.Type type) {
        return switch (type) {
            ...
            case CHESTPLATE -> 15 * durabilityMultiplier;
            case LEGGINGS -> 16 * durabilityMultiplier;
